...
const btnStack = (project) => {
  ...
  const lBtnContainer = document.createElement('div');
  lBtnContainer.className = 'pop-btn-container';

  const liveBtnImg = document.createElement('img');
  liveBtnImg.src = 'assets/images/ic_link.svg';
  lBtnContainer.appendChild(liveBtnImg);
  liveBtn.textContent = 'See Live';
  liveBtn.appendChild(lBtnContainer);

  const sourceBtn = document.createElement('button');
  sourceBtn.className = 'pop-util-btn';

  let sBtnContainer = document.createElement('div');

  sBtnContainer.className = 'pop-btn-container';
  ...
  sBtnContainer.innerHTML += sourceBtnImg;
  sourceBtn.appendChild(sBtnContainer);
  ...
  let svgImg = sBtnContainer.firstChild;

  sourceBtn.addEventListener('mouseover', () => {
    svgImg.setAttribute('fill', 'white');
  });

  sourceBtn.addEventListener('mouseout', () => {
    svgImg.setAttribute('fill', '#1a2236');
  });
